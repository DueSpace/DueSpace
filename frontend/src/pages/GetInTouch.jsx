...
export const GetInTouch = () => {
  return (
    ...
    >
      ...
      <h2 className="mb-5 text-3xl w-90.25 text-gray-900">
        Connect with the DueSpace ecosystem
      </h2>
      <p className="mb-5 text-4 w-90.25">
      ...
      <div className="w-90.5 pt-2 pb-7 text-gray-900 border border-[#111111] bg-[#FFFFFF]">
        ...
        <a href="https://tally.so/r/ODg90k">
          <button className="btn border font-normal text-[15px] tracking-tight border-[#7C3AED] p-7 ml-3 my-1">
            Start a project
          </button>
        </a>
      </div>
